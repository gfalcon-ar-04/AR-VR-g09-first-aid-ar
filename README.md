...
Asistente AR de primeros auxilios que guía paso a paso procedimientos de emergencia sobre el paciente.

| Campo | Detalle |
|-------|---------|
| **Tipo XR** | AR |
| **Motor** | Unity 2022.3.62f1 |
| **Tecnología principal** | ARPlaneManager + ARRaycastManager + UI World Space |
...
- AR Foundation 5.1.x
- ARPlaneManager + ARRaycastManager + UI World Space
